  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex max-w-5xl flex-col items-center px-6 text-center">
        ...
        >
          <JujuLogo variant="stacked" color="coral" className="h-48 md:h-64 lg:h-80 w-auto" />
        </motion.div>
        ...
        <motion.p
          ...
          className="mt-6 text-lg md:text-2xl lg:text-3xl font-medium text-white/80 max-w-2xl"
        >
          {t('tagline')}
        </motion.p>
